...
def yolo_detect(image_path, size):
    os.system("python yolov7/detect.py --weights yolov7/runs/train/yolov7-tiny_custom_5/weights/best.pt --save-txt --no-trace --img-size " + str(size) + " --source " + image_path)
    # os.system("python yolov7/detect.py --weights yolov7/runs/train/yolov7-custom101t/weights/best.pt --save-txt --no-trace --img-size " + str(size) + " --source " + image_path)
